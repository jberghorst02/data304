...
Note: I'm not sure why there's no legend showing up.
...
For some reason the 'fill' and the projection is not working. It's probably an issue with the lookup, but I haven't been able to identify it.
