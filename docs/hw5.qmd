...
I've tried to aggregate and show just one year, but with no luck. I'm also not sure why there's no legend.
...
For some reason the 'fill' and the projection is not working. Probably an issue with the lookup.
